...
window.form = (function () {
  ...
  selectToSync.addEventListener('change', function () {
    window.synchronizeFields(selectToSync, ['12:00', '13:00', '14:00'], selectToSync2, ['12:00', '13:00', '14:00'], window.form.syncValue);
  });
  selectToSync2.addEventListener('change', function () {
    window.synchronizeFields(selectToSync2, ['12:00', '13:00', '14:00'], selectToSync, ['12:00', '13:00', '14:00'], window.form.syncValue);
  });
  elementPrice.addEventListener('change', function () {
    window.synchronizeFields(elementPrice, ['flat', 'bungalo', 'house', 'palace'], price, ['1000', '0', '5000', '10000'], window.form.syncValue);
  });
  elementGuests.addEventListener('change', function () {
    window.synchronizeFields(elementGuests, ['1', '2', '3', '100'], guests, [rooms1, rooms2, rooms3, rooms100], window.form.syncGuests);
  });
  return {
    syncValue: function (element1, array1, element2, array2) {
    ...
    syncGuests: function (element1, array1, element2, array2) {
